...
typedef enum _IPCOMMAND
{
    ...
    IPxyPWMRead                                              = 0x0A,    // PGM-1 PWM output setting DATA READ(0~6), 3bit, 0x00
    IPxyPWMWrite                                             = 0x8A,    // PGM-1 PWM output setting DATA WRITE
    IPxyREARRead                                             = 0x0B,    // PGM-1 SLOW DOWN/REAR PULSE READ, 32bit, 0x00000000
    IPxyREARWrite                                            = 0x8B,    // PGM-1 SLOW DOWN/REAR PULSE WRITE
    IPxySPDRead                                              = 0x0C,    // PGM-1 current SPEED DATA READ, 16bit, 0x0000
    IPxyNoOperation_8C                                       = 0x8C,    // No operation
    IPxySPDCMPRead                                           = 0x0D,    // PGM-1 current SPEED compare DATA READ, 16bit, 0x0000
    IPxySPDCMPWrite                                          = 0x8D,    // PGM-1 current SPEED compare DATA WRITE
    ...
    IPxySPDCMPRead_1D                                        = 0x1D,    // PGM-1 current SPEED compare DATA READ(Same with 0x0D) 
    IPxySPDCMPWrite_9D                                       = 0x9D,    // PGM-1 current SPEED compare DATA WRITE(Same with 0x8D) 
    ...
    IPxyPORGDRV                                              = 0xA4,    // +ORIGIN(Home) SEARCH DRIVE
    ...
    IPxyMORGDRV                                              = 0xA9,    // -ORIGIN(Home) SEARCH DRIVE
    ...
    IPxyDRIVEMODERead                                        = 0x2D,    // Drive action setting DATA READ
    IPxyDRIVEMODEWrite                                       = 0xAD,    // Drive action setting DATA WRITE
    ...
    IPxySWLMTCONRead                                         = 0x36,    // SOFT LIMIT setting READ, 3bit, 0x00
    IPxySWLMTCONWrite                                        = 0xB6,    // SOFT LIMIT setting WRITE
    IPxyMSWLMTCOMPRead                                       = 0x37,    // -SOFT LIMIT compare register setting READ, 32bit, 0x80000000
    IPxyMSWLMTCOMPWrite                                      = 0xB7,    // -SOFT LIMIT compare register setting WRITE
    IPxyPSWLMTCOMPRead                                       = 0x38,    // +SOFT LIMIT compare register setting READ, 32bit, 0x7FFFFFFF
    IPxyPSWLMTCOMPWrite                                      = 0xB8,    // +SOFT LIMIT compare register setting WRITE
    IPxyTRGCONRead                                           = 0x39,    // TRIGGER MODE setting READ, 32bit, 0x00010000
    IPxyTRGCONWrite                                          = 0xB9,    // TRIGGER MODE setting WRITE
    IPxyTRGCOMPRead                                          = 0x3A,    // TRIGGER compare data setting READ, 32bit, 0x00000000
    IPxyTRGCOMPWrite                                         = 0xBA,    // TRIGGER compare data setting WRITE
    IPxyICMRead                                              = 0x3B,    // INTERNAL M-DATA setting READ, 32bit, 0x80000000
    IPxyICMWrite                                             = 0xBB,    // INTERNAL M-DATA setting WRITE
    IPxyECMRead                                              = 0x3C,    // EXTERNAL M-DATA setting READ, 32bit, 0x80000000
    IPxyECMWrite                                             = 0xBC,    // EXTERNAL M-DATA setting WRITE
    ...
    IPySCRCON1Read                                           = 0x40,    // Script action setting register-1 READ, 32bit, 0x00000000
    IPySCRCON1Write                                          = 0xC0,    // Script action setting register-1 WRITE
    IPySCRCON2Read                                           = 0x41,    // Script action setting register-2 READ, 32bit, 0x00000000
    IPySCRCON2Write                                          = 0xC1,    // Script action setting register-2 WRITE
    IPySCRCON3Read                                           = 0x42,    // Script action setting register-3 READ, 32bit, 0x00000000 
    IPySCRCON3Write                                          = 0xC2,    // Script action setting register-3 WRITE
    IPySCRCONQRead                                           = 0x43,    // Script action setting register-Queue READ, 32bit, 0x00000000
    IPySCRCONQWrite                                          = 0xC3,    // Script action setting register-Queue WRITE
    IPySCRDATA1Read                                          = 0x44,    // Script action data register-1 READ, 32bit, 0x00000000 
    IPySCRDATA1Write                                         = 0xC4,    // Script action data register-1 WRITE
    IPySCRDATA2Read                                          = 0x45,    // Script action data register-2 READ, 32bit, 0x00000000 
    IPySCRDATA2Write                                         = 0xC5,    // Script action data register-2 WRITE
    IPySCRDATA3Read                                          = 0x46,    // Script action data register-3 READ, 32bit, 0x00000000 
    IPySCRDATA3Write                                         = 0xC6,    // Script action data register-3 WRITE
    IPySCRDATAQRead                                          = 0x47,    // Script action data register-Queue READ, 32bit, 0x00000000 
    IPySCRDATAQWrite                                         = 0xC7,    // Script action data register-Queue WRITE
    IPyNoOperation_48                                        = 0x48,    // No operation
    IPySCRQCLR                                               = 0xC8,    // Script Queue clear
    IPySCRCQSIZERead                                         = 0x49,    // Script action setting Queue index READ, 4bit, 0x00
    IPyNoOperation_C9                                        = 0xC9,    // No operation
    IPySCRDQSIZERead                                         = 0x4A,    // Script action data Queue index READ, 4bit, 0x00
    IPyNoOperation_CA                                        = 0xCA,    // No operation
    IPySCRQFLAGRead                                          = 0x4B,    // Script Queue Full/Empty Flag READ, 4bit, 0x05
    IPyNoOperation_CB                                        = 0xCB,    // No operation
    IPySCRQSIZECONRead                                       = 0x4C,    // Script Queue size setting(0~13) READ, 16bit, 0xD0D0
    IPySCRQSIZECONWrite                                      = 0xCC,    // Script Queue size setting(0~13) WRITE
    IPySCRQSTATUSRead                                        = 0x4D,    // Script Queue status READ, 12bit, 0x005
    ...
    IPyCAPCON1Read                                           = 0x50,    // Caption action setting register-1 READ, 32bit, 0x00000000
    IPyCAPCON1Write                                          = 0xD0,    // Caption action setting register-1 WRITE
    IPyCAPCON2Read                                           = 0x51,    // Caption action setting register-2 READ, 32bit, 0x00000000
    IPyCAPCON2Write                                          = 0xD1,    // Caption action setting register-2 WRITE
    IPyCAPCON3Read                                           = 0x52,    // Caption action setting register-3 READ, 32bit, 0x00000000 
    IPyCAPCON3Write                                          = 0xD2,    // Caption action setting register-3 WRITE
    IPyCAPCONQRead                                           = 0x53,    // Caption action setting register-Queue READ, 32bit, 0x00000000
    IPyCAPCONQWrite                                          = 0xD3,    // Caption action setting register-Queue WRITE
    IPyCAPDATA1Read                                          = 0x54,    // Caption action setting register-1 READ, 32bit, 0x00000000 
    IPyNoOperation_D4                                        = 0xD4,    // No operation
    IPyCAPDATA2Read                                          = 0x55,    // Caption action data register-2 READ, 32bit, 0x00000000 
    IPyNoOperation_D5                                        = 0xD5,    // No operation
    IPyCAPDATA3Read                                          = 0x56,    // Caption action data register-3 READ, 32bit, 0x00000000 
    IPyNoOperation_D6                                        = 0xD6,    // No operation
    IPyCAPDATAQRead                                          = 0x57,    // Caption action data register-Queue READ, 32bit, 0x00000000 
    IPyNoOperation_D7                                        = 0xD7,    // No operation
    IPyNoOperation_58                                        = 0x58,    // No operation
    IPyCAPQCLR                                               = 0xD8,    // Caption Queue clear
    IPyCAPCQSIZERead                                         = 0x59,    // Caption action setting Queue index READ, 4bit, 0x00
    IPyNoOperation_D9                                        = 0xD9,    // No operation
    IPyCAPDQSIZERead                                         = 0x5A,    // Caption action data Queue index READ, 4bit, 0x00
    ...
    IPyCAPQSIZECONRead                                       = 0x5C,    // Caption Queue size setting(0~13) READ, 16bit, 0xD0D0
    IPyCAPQSIZECONWrite                                      = 0xDC,    // Caption Queue size setting(0~13) WRITE
    ...
    IPxyEXFILTERDRead                                        = 0x6A,    // External sensor filter bandwidth setting DATA READ, 32bit, 0x00050005
    IPxyEXFILTERDWrite                                       = 0xEA,    // External sensor filter bandwidth setting DATA WRITE
    ...
    IPxyFUNCONRead                                           = 0x70,    // Chip function setting DATA READ,
    IPxyFUNCONWrite                                          = 0xF0,    // Chip function setting DATA WRITE
    ...
    IPxyEXCNTCLRRead                                         = 0x77,    // EXTERNAL COUNTER setting DATA READ, 9bit, 0x00
    IPxyEXCNTCLRWrite                                        = 0xF7,    // EXTERNAL COUNTER setting DATA WRITE
...
#define QI_OPERATION_COMMAND(Command, Axis)      ((Command & 0xFF) << ((Axis % 4) * 8)) // bit 7..0 : See enum _QISCOMMAND
